...
The table we are currently working with is BostonUnderwater_Beacon
'''
...
if __name__ == '__main__':
	...
	print "\n\n"
	#foo = Database("SELECT * FROM bostonunderwater_beacon WHERE water_level >= 0")
	#foo = Database("INSERT INTO bostonunderwater_beacon (latitude, longitude, water_level, node_number, time) VALUES (50, 50, 1, 'a0000034a6193f', '2015/05/01 16:49.32')")
	#foo = Database("INSERT INTO bostonunderwater_beacon (latitude, longitude, water_level, node_number, time) VALUES (0.0, 0.0, 1, 'a0000034a6193f', '2015/05/1 16:49:32')")
